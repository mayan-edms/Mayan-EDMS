...
BINARY_MAYAN=${MAYAN_INSTALLATION_FOLDER}bin/mayan-edms.py
BINARY_PIP=${MAYAN_INSTALLATION_FOLDER}bin/pip
MAYAN_DATABASE_HOST=127.0.0.1
MAYAN_DATABASE_NAME=mayan
MAYAN_DATABASE_PASSWORD=mayanuserpass
MAYAN_DATABASE_USERNAME=mayan
MAYAN_MEDIA_ROOT=/opt/mayan-edms/media/
MAYAN_VERSION="mayan-edms>=4.0"
...
sudo python3 -m venv ${MAYAN_INSTALLATION_FOLDER}
