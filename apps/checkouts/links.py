...
checkout_list = {'text': _(u'check ins/outs'), 'view': 'checkout_list', 'famfam': 'basket'}
...
checkin_document = {'text': _('check in document'), 'view': 'checkin_document', 'args': 'object.pk', 'famfam': 'basket_remove', 'condition': is_checked_out}#, 'permissions': [PERMISSION_DOCUMENT_CHECKIN]}
