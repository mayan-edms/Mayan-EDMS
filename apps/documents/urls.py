...
urlpatterns = patterns('documents.views',
    ...
    url(r'^(?P<document_id>\d+)/view/advanced/$', 'document_view_advanced', (), 'document_view_advanced'),
    url(r'^(?P<document_id>\d+)/view/$', 'document_view_simple', (), 'document_view_simple'),
    ...
    url(r'^(?P<document_id>\d+)/create/siblings/$', 'document_create_sibling', 'document_create_sibling'),
