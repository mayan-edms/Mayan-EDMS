    ...
    def initialize(cls):
        for app in apps.get_app_configs():
            try:
                ...
                if force_text(exception) not in ('No module named {module_name}', 'No module named \'{app_label}.{module_name}\''.format(app_label=app.name, module_name=cls._loader_module_name)):
                    logger.error(
