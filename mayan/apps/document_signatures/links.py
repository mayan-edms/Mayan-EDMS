...
link_document_file_all_signature_verify = Link(
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_all_signature_verify',
...
link_document_file_signature_delete = Link(
    ...
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_delete',
...
link_document_file_signature_detached_create = Link(
    ...
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_detached_create',
...
link_document_file_signature_details = Link(
    args='resolved_object.pk',
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_details',
    permissions=(permission_document_file_signature_view,),
    text=_('Details'), view='signatures:document_file_signature_details',
)
link_document_file_signature_download = Link(
    args='resolved_object.pk',
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_download',
...
link_document_file_signature_embedded_create = Link(
    args='resolved_object.pk',
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_embedded_create',
...
link_document_file_signature_list = Link(
    args='resolved_object.pk',
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_list',
    permissions=(permission_document_file_signature_view,),
    text=_('Signatures'), view='signatures:document_file_signature_list'
)
link_document_file_signature_upload = Link(
    args='resolved_object.pk',
    icon_class_path='mayan.apps.document_signatures.icons.icon_document_file_signature_upload',
