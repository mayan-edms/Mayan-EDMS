...
class CabinetTestCase(CabinetTestMixin, BaseTestCase):
    def test_cabinet_creation(self):
        ...
        self.assertEqual(events[0].actor, self.test_cabinet)
    ...
    def test_cabinet_editing(self):
        ...
        test_cabinet_label = self.test_cabinet.label

        self.test_cabinet.label = TEST_CABINET_LABEL_EDITED
        self.test_cabinet.save()

        self.assertNotEqual(self.test_cabinet.label, test_cabinet_label)
...
class CabinetDocumentTestCase(
    ...
    def test_cabinet_get_document_count_method(self):
        ...
        self.assertEqual(
            self.test_cabinet.get_document_count(user=self._test_case_user),
