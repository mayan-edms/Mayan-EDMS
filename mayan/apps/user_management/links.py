...
link_group_user_list = Link(
    args='object.id', icon_class=icon_group_user_list,
...
link_user_group_list = Link(
    args='object.id', icon_class=icon_user_group_list,
...
link_user_multiple_delete = Link(
    icon_class=icon_user_delete, permissions=(permission_user_delete,),
