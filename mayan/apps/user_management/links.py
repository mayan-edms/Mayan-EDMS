...
user_setup = {'text': _('Users'), 'view': 'user_management:user_list', 'famfam': 'user', 'icon': 'appearance/icons/user.png', 'permissions': [PERMISSION_USER_VIEW]}
...
group_setup = {'text': _('Groups'), 'view': 'user_management:group_list', 'famfam': 'group', 'icon': 'appearance/icons/group.png', 'permissions': [PERMISSION_GROUP_VIEW]}
