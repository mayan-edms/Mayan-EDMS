...
user_setup = {'text': _('Users'), 'view': 'user_management:user_list', 'icon': 'fa fa-user', 'permissions': [PERMISSION_USER_VIEW]}
...
group_setup = {'text': _('Groups'), 'view': 'user_management:group_list', 'icon': 'fa fa-group', 'permissions': [PERMISSION_GROUP_VIEW]}
