...
class UpdateDocumentPageOCRActionViewTestCase(
    ...
    def test_update_document_version_page_ocr_workflow_state_action_create_post_view_no_permission(self):
    ...
    def test_update_document_version_page_ocr_workflow_state_action_create_post_view_with_access(self):
        self.grant_access(
