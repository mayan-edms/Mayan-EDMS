...
class OCRAPIViewTestCase(
    ...
    def test_submit_document_file_api_view_no_permission(self):
        response = self._request_document_file_ocr_submit_view()
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_submit_document_file_api_view_with_access(self):
        self.grant_access(
