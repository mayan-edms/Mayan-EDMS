...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Folder.datetime_created'
        db.alter_column(u'folders_folder', 'datetime_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Folder.datetime_created'
        db.alter_column(u'folders_folder', 'datetime_created', self.gf('django.db.models.fields.DateTimeField')())
