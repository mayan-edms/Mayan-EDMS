...
link_document_type_smart_links = Link(
    args='resolved_object.pk', icon_class=icon_document_type_smart_links,
...
link_smart_link_condition_delete = Link(
    args='resolved_object.pk', icon_class=icon_smart_link_condition_delete,
...
link_smart_link_condition_edit = Link(
    args='resolved_object.pk', icon_class=icon_smart_link_condition_edit,
...
link_smart_link_condition_list = Link(
    args='object.pk', icon_class=icon_smart_link_condition_list,
...
link_smart_link_delete = Link(
    args='object.pk', icon_class=icon_smart_link_delete,
...
link_smart_link_document_types = Link(
    args='object.pk', icon_class=icon_smart_link_document_types,
...
link_smart_link_edit = Link(
    args='object.pk', icon_class=icon_smart_link_edit,
    permissions=(permission_smart_link_edit,), text=_('Edit'),
...
link_smart_link_list = Link(
    icon_class=icon_smart_link_list,
