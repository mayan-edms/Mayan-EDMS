...
class DocumentMetadataViewTestCase(
    ...
    def test_document_metadata_edit_after_document_type_change(self):
        ...
        self.test_document.set_document_type(
...
class DocumentMetadataRequiredTestCase(
    ...
    def setUp(self):
        ...
        self._create_test_metadata_type()
        self._create_test_metadata_type()
        self._test_document_type_metadata_types = []

        self._test_document_type_metadata_types.append(
            self.test_document_type.metadata.create(
                metadata_type=self.test_metadata_types[0], required=False
            )
        )
