...
TEST_PARSER_PATH_DATE = 'mayan.apps.metadata.parsers.DateParser'
TEST_VALID_DATE = '2001-1-1'
TEST_VALIDATOR_PATH_DATE = 'mayan.apps.metadata.validators.DateValidator'
TEST_VALIDATOR_PATH_REGULAR_EXPRESSION = 'mayan.apps.metadata.validators.RegularExpressionValidator'
