...
link_metadata_multiple_add = Link(
    icon_class=icon_document_metadata_add, text=_('Add metadata'),
    view='metadata:metadata_multiple_add'
)
link_metadata_multiple_edit = Link(
    icon_class=icon_document_metadata_edit, text=_('Edit metadata'),
    view='metadata:metadata_multiple_edit'
)
link_metadata_multiple_remove = Link(
    icon_class=icon_document_metadata_remove, text=_('Remove metadata'),
...
link_setup_document_type_metadata_types = Link(
    ...
    icon_class=icon_document_type_metadata_type_list,
...
link_setup_metadata_type_document_types = Link(
    args='resolved_object.pk',
    icon_class=icon_metadata_type_document_type_list,
    permissions=(permission_document_type_edit,),
