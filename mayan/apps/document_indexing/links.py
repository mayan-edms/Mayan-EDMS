...
link_document_index_instance_list = Link(
    args='resolved_object.pk', icon_class=icon_document_index_instance_list,
    text=_('Indexes'), view='indexing:document_index_list'
)

link_document_type_index_templates = Link(
    args='resolved_object.pk', icon_class=icon_document_type_index_templates,
...
link_index_instance_rebuild = Link(
    args='resolved_object.pk', icon_class=icon_index_instances_rebuild,
...
link_index_instances_rebuild = Link(
    ...
    ), icon_class=icon_index_instances_rebuild, text=_('Rebuild indexes'),
...
link_index_instances_reset = Link(
    condition=get_cascade_condition(
        ...
        'Deletes and creates from scratch all the document indexes.'
    ), icon_class=icon_index_instances_reset, text=_('Reset indexes'),
...
link_index_template_list = Link(
    icon_class=icon_index_template_list, text=_('Indexes'),
    view='indexing:index_setup_list'
)
...
link_index_template_document_types = Link(
    args='resolved_object.pk', icon_class=icon_index_template_document_types,
...
link_index_template_edit = Link(
    args='resolved_object.pk', icon_class=icon_index_template_edit,
...
link_index_template_node_tree_view = Link(
    args='resolved_object.pk', icon_class=icon_index_template_node_tree_view,
...
link_index_template_node_create = Link(
    args='resolved_object.pk', icon_class=icon_index_template_node_create,
...
link_index_template_node_delete = Link(
    ...
    icon_class=icon_index_template_node_delete, tags='dangerous',
    text=_('Delete'), view='indexing:template_node_delete'
)
link_index_template_node_edit = Link(
    args='resolved_object.pk', icon_class=icon_index_template_node_edit,
