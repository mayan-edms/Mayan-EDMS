...
link_document_file_content = Link(
    args='resolved_object.id', icon_class=icon_document_file_content,
...
link_document_file_content_delete = Link(
    args='resolved_object.id', icon_class=icon_document_file_content_delete,
...
link_document_file_content_download = Link(
    args='resolved_object.id',
    icon_class=icon_document_file_content_download,
