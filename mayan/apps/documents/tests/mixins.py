...
from .literals import (
    ...
    TEST_DOCUMENT_VERSION_COMMENT_EDITED, TEST_DUPLICATED_DOCUMENT_LABEL,
...
class DocumentTypeDeletionPoliciesViewTestMixin:
    def _request_document_type_deletion_policies_get_view(self):
        return self.get(
...
class DuplicatedDocumentsViewsTestMixin:
    ...
    def _upload_duplicate_document(self):
        self._upload_test_document(label=TEST_DUPLICATED_DOCUMENT_LABEL)
