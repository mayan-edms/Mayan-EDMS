...
class DocumentViewTestCase(
    ...
    def test_trashed_document_download_form_get_view_with_access(self):
        self.grant_access(
            obj=self.test_document, permission=permission_document_download
        )
    ...
    def test_trashed_document_download_form_post_view_with_access(self):
        self.grant_access(
            obj=self.test_document, permission=permission_document_download
        )
    ...
    def test_trashed_document_download_view_with_permission(self):
        self.grant_access(
            obj=self.test_document, permission=permission_document_download
        )
