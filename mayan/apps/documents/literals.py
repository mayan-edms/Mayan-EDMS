...
DEFAULT_DOCUMENTS_CACHE_STORAGE_BACKEND = 'django.core.files.storage.FileSystemStorage'
DEFAULT_DOCUMENTS_CACHE_STORAGE_BACKEND_ARGUMENTS = {
    'location': os.path.join(settings.MEDIA_ROOT, 'document_cache')
}
...
DEFAULT_DOCUMENTS_RECENT_ACCESS_COUNT = 400
DEFAULT_DOCUMENTS_RECENT_ADDED_COUNT = 400
