    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(default='46845ca5-d94d-4669-9d7b-7886e2bac036', max_length=48, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_label', models.CharField(max_length=40, null=True, verbose_name='Page label', blank=True)),
                ('page_number', models.PositiveIntegerField(default=1, verbose_name='Page number', editable=False, db_index=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('filename', models.CharField(max_length=128, verbose_name='Filename', db_index=True)),
                ('enabled', models.BooleanField(default=True, verbose_name='Enabled')),
                ('document_type', models.ForeignKey(related_name='filenames', verbose_name='Document type', to='documents.DocumentType')),
            ],
            options={
                'ordering': ['filename'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='2a2af9b3-8079-4753-9863-f1c342ec0d06', storage=storage.backends.filebasedstorage.FileBasedStorage(), verbose_name='File')),
                ...
                ('document', models.ForeignKey(related_name='versions', verbose_name='Document', to='documents.Document')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('datetime_accessed', models.DateTimeField(auto_now=True, verbose_name='Accessed', db_index=True)),
                ('document', models.ForeignKey(editable=False, to='documents.Document', verbose_name='Document')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='pages', verbose_name='Document version', to='documents.DocumentVersion'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='document',
            name='document_type',
            field=models.ForeignKey(related_name='documents', verbose_name='Document type', to='documents.DocumentType'),
            preserve_default=True,
        ),
    ]
