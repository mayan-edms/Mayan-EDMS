...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.document_type'
        db.alter_column(u'documents_document', 'document_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.DocumentType']))

    def backwards(self, orm):

        # Changing field 'Document.document_type'
        db.alter_column(u'documents_document', 'document_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['documents.DocumentType']))
