...
#    icon_document_version_page_navigation_last, icon_document_version_page_navigation_next,
#    icon_document_version_page_navigation_previous, icon_document_version_page_return,
#    icon_document_version_page_rotate_left, icon_document_version_page_rotate_right,
...
def is_document_version_page_enabled(context):
    return context['resolved_object'].enabled


def is_document_version_page_disabled(context):
    return not context['resolved_object'].enabled


'''
link_document_version_page_disable = Link(
    condition=is_document_version_page_enabled,
    icon_class_path='mayan.apps.documents.icons.icon_document_version_page_disable',
    kwargs={'document_version_page_id': 'resolved_object.id'},
    permissions=(permission_document_edit,), text=_('Disable page'),
    view='documents:document_version_page_disable'
)
link_document_version_page_multiple_disable = Link(
    icon_class_path='mayan.apps.documents.icons.icon_document_version_page_disable',
    text=_('Disable pages'),
    view='documents:document_version_page_multiple_disable'
)
link_document_version_page_enable = Link(
    condition=is_document_version_page_disabled,
    icon_class_path='mayan.apps.documents.icons.icon_document_version_page_enable',
    kwargs={'document_version_page_id': 'resolved_object.id'},
    permissions=(permission_document_edit,), text=_('Enable page'),
    view='documents:document_version_page_enable'
)
link_document_version_page_multiple_enable = Link(
    icon_class_path='mayan.apps.documents.icons.icon_document_version_page_enable',
    text=_('Enable pages'),
    view='documents:document_version_page_multiple_enable'
)
...
link_document_version_page_navigation_last = Link(
    ...
    icon_class=icon_document_version_page_navigation_last,
...
link_document_version_page_navigation_previous = Link(
    args='resolved_object.pk', conditional_disable=is_first_page,
    icon_class=icon_document_version_page_navigation_previous,
    keep_query=True, permissions=(permission_document_view,),
...
link_document_version_page_navigation_next = Link(
    args='resolved_object.pk', conditional_disable=is_last_page,
    icon_class=icon_document_version_page_navigation_next,
...
link_document_version_page_return = Link(
    args='resolved_object.document.pk', icon_class=icon_document_version_page_return,
...
link_document_version_page_rotate_right = Link(
    args='resolved_object.pk', icon_class=icon_document_version_page_rotate_right,
    keep_query=True, permissions=(permission_document_view,),
    text=_('Rotate right'), view='documents:document_version_page_rotate_right',
)
link_document_version_page_view = Link(
    conditional_disable=is_document_version_page_disabled,
...
link_document_version_page_zoom_in = Link(
    ...
    icon_class=icon_document_version_page_zoom_in, keep_query=True,
...
'''
link_document_version_pages = Link(
    args='resolved_object.pk',
    icon_class_path='mayan.apps.documents.icons.icon_document_version_pages',
    permissions=(permission_document_view,), text=_('Pages'),
    view='documents:document_version_pages',
)
'''
