...
TEST_WORKFLOW_TEMPLATE_STATE_ACTION_LABEL_2 = 'test template state action label 2'
...
TEST_WORKFLOW_TEMPLATE_TRANSITION_LABEL_2 = 'test workflow template transition label 2'
