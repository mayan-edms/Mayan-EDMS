...
from ..permissions import (
    permission_workflow_template_edit, permission_workflow_instance_transition,
...
class WorkflowTransitionViewTestCase(
    ...
    def test_workflow_template_transition_create_view_with_access(self):
        ...
        self.assertEqual(events[0].action_object, self.test_workflow_template_transition)
    ...
    def test_workflow_template_transition_list_view_no_permission(self):
        ...
        self.assertNotContains(
            response=response, text=self.test_workflow_template_transition.label,
            status_code=404
        )
        events = self._get_test_events()
        self.assertEqual(events.count(), 0)
...
class WorkflowTransitionEventViewTestCase(
    ...
    def test_workflow_template_transition_selection_get_view_with_workflow_access(self):
        self.grant_access(
    ...
    def test_workflow_template_transition_selection_post_view_with_workflow_access(self):
        self.grant_access(
            obj=self.test_workflow_template, permission=permission_workflow_instance_transition
        )
    ...
    def test_workflow_template_transition_execute_view_no_permission(self):
        """
    ...
    def test_workflow_template_transition_execute_view_with_workflow_access(self):
        """
    ...
    def test_workflow_template_transition_execute_view_with_transition_access(self):
        """
        Test transitioning a workflow by granting the transition workflow
        permission to the role.
        """
...
class WorkflowTransitionFieldViewTestCase(
    ...
    def test_workflow_template_transition_field_create_view_with_access(self):
        ...
        events = self._get_test_events()
        self.assertEqual(events.count(), 1)
        self.assertEqual(events[0].action_object, self.test_workflow_template_transition_field)
        self.assertEqual(events[0].actor, self._test_case_user)
        self.assertEqual(events[0].target, self.test_workflow)
        self.assertEqual(events[0].verb, event_workflow_template_edited.id)
