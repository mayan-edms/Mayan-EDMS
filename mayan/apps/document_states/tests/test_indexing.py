...
from .literals import (
    ...
    TEST_WORKFLOW_TEMPLATE_INTERNAL_NAME, TEST_WORKFLOW_TEMPLATE_INITIAL_STATE_LABEL,
    TEST_WORKFLOW_TEMPLATE_INITIAL_STATE_COMPLETION, TEST_WORKFLOW_TEMPLATE_LABEL,
...
class DocumentStateIndexingTestCase(GenericDocumentTestCase):
    ...
    def test_workflow_indexing_initial_state(self):
        ...
        self.assertEqual(
            ...
            ), ['', TEST_WORKFLOW_TEMPLATE_INITIAL_STATE_LABEL]
        )
