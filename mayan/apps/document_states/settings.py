...
from .literals import (
    ...
    DEFAULT_WORKFLOWS_WORKFLOW_INSTANCE_STATE_EXPIRATION_CHECK_INTERVAL
)
...
setting_workflow_instance_state_expiration_check_interval = namespace.add_setting(
    default=DEFAULT_WORKFLOWS_WORKFLOW_INSTANCE_STATE_EXPIRATION_CHECK_INTERVAL,
    global_name='WORKFLOWS_WORKFLOW_INSTANCE_STATE_EXPIRATION_CHECK_INTERVAL',
    help_text=_(
