...
link_setup_workflow_delete = Link(text=_('Delete'), view='document_states:setup_workflow_delete', args='object.pk')
...
link_setup_workflow_state_delete = Link(text=_('Delete'), view='document_states:setup_workflow_state_delete', args='object.pk')
