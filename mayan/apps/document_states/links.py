...
link_document_type_workflow_templates = Link(
    ...
    icon_class=icon_document_type_workflow_list,
...
link_workflow_template_create = Link(
    icon_class=icon_workflow_template_create,
...
link_workflow_template_multiple_delete = Link(
    icon_class=icon_workflow_template_delete,
...
link_workflow_template_document_types = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_template_document_type_list,
...
link_workflow_template_edit = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_template_edit,
...
link_workflow_template_launch = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_template_launch,
...
link_workflow_template_list = Link(
    icon_class=icon_workflow_template_list,
...
link_workflow_template_preview = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_template_preview,
...
link_workflow_template_state_action_selection = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_state_action,
...
link_document_multiple_workflow_templates_launch = Link(
    icon_class=icon_document_workflow_templates_launch,
...
link_workflow_template_transition_field_create = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_transition_field,
...
link_workflow_template_transition_field_delete = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_transition_field_delete,
    permissions=(permission_workflow_edit,),
    tags='dangerous', text=_('Delete'),
...
link_workflow_template_transition_field_edit = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_transition_field_edit,
    permissions=(permission_workflow_edit,),
...
link_workflow_template_transition_field_list = Link(
    args='resolved_object.pk',
    icon_class=icon_workflow_transition_field_list,
    permissions=(permission_workflow_edit,),
    text=_('Fields'),
...
link_tool_launch_workflows = Link(
    icon_class=icon_tool_launch_workflows,
    permissions=(permission_workflow_tools,),
