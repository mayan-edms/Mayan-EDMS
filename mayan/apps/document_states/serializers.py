...
class WorkflowInstanceLogEntrySerializer(serializers.ModelSerializer):
    document_workflow_template_url = serializers.SerializerMethodField()
    transition = WorkflowTemplateTransitionSerializer(read_only=True)
    user = UserSerializer(read_only=True)

    class Meta:
        fields = (
            'comment', 'datetime', 'document_workflow_template_url', 'transition',
            'user'
        )
        model = WorkflowInstanceLogEntry

    def get_document_workflow_template_url(self, instance):
        return reverse(
...
class WorkflowInstanceSerializer(serializers.ModelSerializer):
    ...
    transition_choices = WorkflowTemplateTransitionSerializer(
    ...
    class Meta:
        fields = (
            ...
            'log_entries_url', 'transition_choices', 'url', 'workflow_template_url'
        )
