...
from .icons import (
    ...
    icon_dependency_group_entry_list, icon_dependency_group_entry_detail,
...
link_dependency_group_list = Link(
    icon_class=icon_dependency_group_list,
...
link_dependency_group_entry_list = Link(
    args='resolved_object.name', icon_class=icon_dependency_group_entry_list,
...
link_dependency_group_entry_detail = Link(
    ...
    icon_class=icon_dependency_group_entry_detail,
...
link_packages_licenses = Link(
    icon_class=icon_dependency_licenses, text=_('Dependencies licenses'),
