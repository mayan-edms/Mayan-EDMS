...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WatchFolderSource.delete_after_upload'
        db.delete_column(u'sources_watchfoldersource', 'delete_after_upload')

    def backwards(self, orm):
        # Adding field 'WatchFolderSource.delete_after_upload'
        db.add_column(u'sources_watchfoldersource', 'delete_after_upload',
