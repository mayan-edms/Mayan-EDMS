...
link_menu_link = {'text': _('Installation details'), 'view': 'installation:namespace_list', 'icon': 'appearance/icons/interface_preferences.png', 'permissions': [PERMISSION_INSTALLATION_DETAILS]}
